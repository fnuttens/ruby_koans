...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # > Same thing as javaScript's reduce and Rust's fold functions (et al): applying a function
    #   to each value of the array with an "accumulator" value, wich is returned at the end of the process.
  end
  ...
  # > I suppose we did it that way so that the file handle is automatically
  #   freed once the do block is completed.
