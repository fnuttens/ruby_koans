...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # > Because they can match an infinity of identical characters.
  ...
  # > There's no need to specify every character for a class (e.g. [a-z]),
  #   and an alternation can consist of more than one character (e.g. (one|two)).
