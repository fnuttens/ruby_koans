...
class AboutSymbols < Neo::Koan
  ...
  # > If one were to call the include method with a symbol, it would mean that this symbol has to exist, since it is being used.
  ...
  # > Maybe this could lead to a collision with an existing symbol?
end
